...
public class GramaticaParser extends Parser {
	...
	public static final int
		...
		RULE_instr = 4, RULE_operacao = 5, RULE_comparacao = 6, RULE_operando = 7;
	private static String[] makeRuleNames() {
		return new String[] {
			"inicio", "declaracao", "decl", "programa", "instr", "operacao", "comparacao", 
			"operando"
		};
	}
	...
	public static class NComparacaoContext extends ComparacaoContext {
		...
		public TerminalNode COMPARADOR() { return getToken(GramaticaParser.COMPARADOR, 0); }
		public NComparacaoContext(ComparacaoContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GramaticaListener ) ((GramaticaListener)listener).enterNComparacao(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GramaticaListener ) ((GramaticaListener)listener).exitNComparacao(this);
		}
	}
