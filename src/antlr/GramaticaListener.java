...
public interface GramaticaListener extends ParseTreeListener {
	 ...
	 * labeled alternative in {@link GramaticaParser#comparacao}.
	 * @param ctx the parse tree
	 */
	void enterNComparacao(GramaticaParser.NComparacaoContext ctx);
	/**
	 * Exit a parse tree produced by the {@code NComparacao}
	 * labeled alternative in {@link GramaticaParser#comparacao}.
	 * @param ctx the parse tree
	 */
	void exitNComparacao(GramaticaParser.NComparacaoContext ctx);
	/**
